...
# 指定目标日期文件夹所在的根目录
root_dir="/home/hanhan210302/BGP_Anomaly_Datasets"
...
for date_dir in "$root_dir"/*/; do
    ...
    for monitor_id in $(seq 0 26); do
        (
            # 创建输出目录（如果不存在）
            rib_output_dir="/home/hanhan210302/BGP_Anomaly_Data_txt/$date/rib/$monitor_id"
            updates_output_dir="/home/hanhan210302/BGP_Anomaly_Data_txt/$date/updates/$monitor_id"
